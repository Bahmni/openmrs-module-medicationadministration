...
public class MedicationAdministrationTranslatorImpl implements MedicationAdministrationTranslator<org.openmrs.MedicationAdministration> {
	...
	@Override
	public MedicationAdministration toFhirResource(@Nonnull org.openmrs.MedicationAdministration openmrsMedicationAdministration) {
	...
	@Override
	public org.openmrs.MedicationAdministration toOpenmrsType(@Nonnull MedicationAdministration medicationAdministration) {
		notNull(medicationAdministration, "The MedicationAdministration object should not be null");
		return toOpenmrsType(new org.openmrs.MedicationAdministration(), medicationAdministration);
	}
	
	@Override
	public org.openmrs.MedicationAdministration toOpenmrsType(
	        @Nonnull org.openmrs.MedicationAdministration existingOpenmrsMedicationAdministration,
